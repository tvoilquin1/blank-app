...
function EditPortfolioEntryModal({ entry, onClose, onSave }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (dateValidation && dateValidation.date) {
      const updatedEntry = {
        symbol: entry.symbol, // Keep original symbol
...
export default EditPortfolioEntryModal;
